...
from evaluation.metrics.rhythmic_patterns import get_style_rhythmic_bigrams_avg
...
class Style:
    def __init__(self, name, df_char, df):
        ...
        self.rhythmic_patterns_distribution = get_style_rhythmic_bigrams_avg(df, name)
