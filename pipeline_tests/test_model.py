...
def test_new_model_1_epoch(sonata15_mapleleaf_prep_8):
    ...
    train_new_model(sonata15_mapleleaf_prep_8, model_name, epochs, 0.01, ckpt=1)
...
def test_new_model_5_epochs(sonata15_mapleleaf_prep_8):
    ...
    epochs = 5
    model_name = "test_new_model"
    train_new_model(sonata15_mapleleaf_prep_8, model_name, epochs, 0.01, ckpt=2)
    callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_0.csv")
...
def test_train_model(sonata15_mapleleaf_prep_8):
    ...
    epochs = 5
    model_name = "test_new_model"
    continue_training(sonata15_mapleleaf_prep_8, model_name, epochs, 0.01, ckpt=2)
...
def test_complete_training(sonata15_mapleleaf_prep_8):
    ...
    final_epoch_1 = 2
    continue_training(sonata15_mapleleaf_prep_8, model_name, final_epoch_1, 0.01, ckpt=1)
    callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_2.csv")
    ...
    final_epoch_2 = 4
    continue_training(sonata15_mapleleaf_prep_8, model_name, final_epoch_2, 0.01, ckpt=1)
...
def test_new_model_1_epoch_4bars(sonata15_mapleleaf_prep_4):
    ...
    train_new_model(sonata15_mapleleaf_prep_4, model_name, epochs, 0.01, ckpt=1)
    callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_0.csv")
...
def test_new_model_5_epochs_4bars(sonata15_mapleleaf_prep_4):
    ...
    epochs = 5
    model_name = "test_new_model-4"
    train_new_model(sonata15_mapleleaf_prep_4, model_name, epochs, 0.01, ckpt=2)
    callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_0.csv")
...
def test_train_model_4bars(sonata15_mapleleaf_prep_4):
    ...
    epochs = 5
    model_name = "test_new_model-4"
    continue_training(sonata15_mapleleaf_prep_4, model_name, epochs, 0.01, ckpt=2)
    callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_2.csv")
...
def test_complete_training_4bars(sonata15_mapleleaf_prep_4):
    ...
    final_epoch_1 = 2
    continue_training(sonata15_mapleleaf_prep_4, model_name, final_epoch_1, 0.01, ckpt=1)
    callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_2.csv")
    ...
    final_epoch_2 = 4
    continue_training(sonata15_mapleleaf_prep_4, model_name, final_epoch_2, 0.01, ckpt=1)
    try:
        callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_4.csv")
    except:
        callbacks = pd.read_csv(get_logs_path(model_name) + f"{model_name}_6.csv")
