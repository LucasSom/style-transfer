...
from utils.files_utils import load_pickle, preprocessed_data_path, logs_path
...
def test_new_model_1_epoch(sonata15_mapleleaf_prep_8):
    ...
    callbacks = pd.read_csv(logs_path + f"{model_name}_0.csv")
...
def test_train_model(sonata15_mapleleaf_prep_8):
    ...
    callbacks = pd.read_csv(logs_path + f"{model_name}_2.csv")
...
def test_complete_training(sonata15_mapleleaf_prep_8):
    ...
    callbacks = pd.read_csv(logs_path + f"{model_name}_5.csv")
...
def test_complete_training_4bars(sonata15_mapleleaf_prep_4):
    ...
    try:
        callbacks = pd.read_csv(logs_path + f"{model_name}_4.csv")
    except:
        callbacks = pd.read_csv(logs_path + f"{model_name}_6.csv")
