...
def overall_evaluation(metrics, plot_dir, context='talk'):
    ...
    sns.heatmap(metrics["Style"], annot=True, annot_kws={'fontsize': 'xx-large'}, fmt=".2f", vmin=0, vmax=100)
    ...
    sns.heatmap(metrics["Musicality"], annot=True, annot_kws={'fontsize': 'xx-large'}, fmt=".2f", vmin=0, vmax=100)
    ...
    sns.heatmap(metrics["Plagiarism-dist"], annot=True, annot_kws={'fontsize': 'xx-large'}, fmt=".2f", vmin=0, vmax=1)
    ...
    sns.heatmap(metrics["Plagiarism-diff"], annot=True, annot_kws={'fontsize': 'xx-large'}, fmt=".2f", vmin=0, vmax=1)
